...
class _GroupManagementPageState extends State<GroupManagementPage> {
  ...
  void initState() {
    super.initState();
    userProfilePicture = NetworkImage('https://static.thenounproject.com/png/1546235-200.png');
    fetchGroupData();
  }
...
Widget build(BuildContext context) {
  ...
  return Scaffold(
    ...
    //Function that fetches all the data to power the page
    ...
    //Edit group name functionality popup
    ...
    Future<void> updateGroupName(String newName) async {
      ...
      //Edit group description functionality popup
    ...
    //Edit group description functionality
    ...
    //Edit group profile picture functionality
    ...
    //Basic user  Leave group functionality
    ...
    //Checking if Admin in order to display the delete group button and remove users login 
    ...
    //Delete group functionality popup
    ...
    //Remove user from group functionality popup
